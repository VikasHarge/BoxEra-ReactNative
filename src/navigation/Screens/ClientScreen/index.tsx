...
import { HomeStackParamsList, RootNavigatorParamList, RootStackScreenProps } from '../../type'
import { InitialClientValues } from '../HomeTab/SelectClient'
import { addClientDetailsAsync } from '../../../store/client'
import { FormikTextInput } from '../../../components/Form/TextInput'
import { styles } from '../HomeTab/Home'
...
const SelectClient
  = ({ navigation } : RootStackScreenProps<'Clients'>) => {
    ...
    const handleSubmit = async (values: InitialClientValues, { setErrors }: FormikHelpers<InitialClientValues>) => {
     ...
     await dispatch(addClientDetailsAsync({
      ...values,
      estimates : [],
     }))
      setIsOpen(false)
          ...
          <View style={{
...

            {
              clients && clients?.length > 0 ? <>
                ...
                <Text>No Clients. Add Client to start.</Text>
              </View>
            }
          </View>
        </ScrollView>
